                ...
                <form method="post" action="calculator.php?action=method2_process" name="form1" id="form1">
                    <table class="table table-condensed" style="max-width:600px;">
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="watt_0" id="watt_0" value="0" class="form-control"
                        ...
                        <tr>
                            ...
                            <td><input type="text" name="watt_2" id="watt_2" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_3" id="watt_3" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_4" id="watt_4" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_5" id="watt_5" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_6" id="watt_6" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_7" id="watt_7" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_8" id="watt_8" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_9" id="watt_9" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_10" id="watt_10" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_11" id="watt_11" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_12" id="watt_12" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_13" id="watt_13" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_14" id="watt_14" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_15" id="watt_15" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_16" id="watt_16" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_17" id="watt_17" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_18" id="watt_18" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td><input type="text" name="watt_19" id="watt_19" value="0" class="form-control"
                                       style="max-width:70px; max-height:30px; ">
                            </td>
                        </tr>
                        <tr>
