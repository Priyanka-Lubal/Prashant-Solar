            ...
            <div class="col-lg-12 text-center">
                ...
                <div id="carousel-example-generic" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <div class="item">
                            <img class="img-responsive img-full" src="img/backg.jpg" alt="">
                        </div>
                        <div class="item">
    ...
    <div class="row">
        <div class="box">
            <div class="col-lg-12">
                ...
                <ol type="1">
                    <hr class="visible-xs">
                    <li>In the maximum efficiency division, we study the performance of all our panels throughout the
                        product value chain, from the silicon extraction process, the treatment of the solar cells and
                        their subsequent transformation into the TM-Series® solar panels that we offer our customers.
                    </li>
                    <li>High performance, quality, respect for the environment and making clean energy profitable are
                        our motivation to continue evolving in this industry.
                    </li>
                    <li>Satisfaction of saving the environment and energy that will make a large difference.
                    </li>
                    <li>Independence and Security.</li>
                    <li>A single 2kW solar power system from Prashant Solar will reduce CO2 emissions by about 2 tonnes
                        per year , thus helping earth more sustainable over the years and future generation to be more
                        secure and healthy.
                    </li>
                </ol>
